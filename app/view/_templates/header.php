...
<head>
	...
	<script src='<?php echo URL; ?>_js/imagemodal.js' type="text/javascript"></script>
	<script src='<?php echo URL; ?>_js/utilities.js' type="text/javascript"></script>
	<script src='<?php echo URL; ?>_js/application.js' type="text/javascript"></script>
